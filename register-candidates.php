        ...
        <div class="row latest-job margin-top-50 margin-bottom-20 bg-white">
          ...
          <form method="post" id="registerCandidates" action="adduser.php" enctype="multipart/form-data">
            ...
            <div class="col-md-6 latest-job ">
              ...
              <div class="form-group">
                <input class="form-control input-lg" type="text" id="city" name="city" placeholder="County">
              </div>
              <div class="form-group">
                <input class="form-control input-lg" type="text" id="state" name="state" placeholder="Constituency">
              </div>
              <div class="form-group">
