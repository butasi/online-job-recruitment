...
<div class="wrapper">
                ...
                <ul class="nav nav-pills nav-stacked tree" data-widget="tree">
                  <li class="treeview menu-open">
                    ...
                    <ul class="treeview-menu">
                      <li><a href=""  class="citySearch" data-target="Nairobi"><i class="fa fa-circle-o text-yellow"></i> Nairobi</a></li>
                      <li><a href="" class="citySearch" data-target="Eldoret"><i class="fa fa-circle-o text-yellow"></i> Eldoret</a></li>
                    </ul>
                  </li>
                  <li class="treeview menu-open">
  ...
  <footer class="main-footer" style="margin-left: 0px;">
    <div class="text-center">
      <strong>Copyright &copy; 2022-2023 <a href="http://github.com/butasi"</a>All rights reserved.</strong>
    </div>
  </footer>
