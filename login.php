...
<body background="C:\xampp\htdocs\projects\Stable\job-portal-master\job.jpg" class="hold-transition skin-blue sidebar-mini">
        ...
        <div class="row latest-job margin-top-50 margin-bottom-20">
          ...
          <div class="col-md-6 latest-job ">
            <div class="small-box bg-red padding-5">
              <div class="inner">
                <h3 class="text-center">Hiring Manager Login</h3>
              </div>
